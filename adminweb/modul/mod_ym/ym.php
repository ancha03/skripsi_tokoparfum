...
switch($_GET[act]){
  // Tampil YM
  default:
    echo "<h2>YM Status Module by MBJ</h2>
    ...
    $tampil=mysqli_query($con,"SELECT * FROM mod_ym ORDER BY id DESC");
    $no=1;
    ...
    echo "</table>";
	echo "<hr><h5> Modul YM Lokomedia Toko Online powered by <a href='http://www.pertemanan.net/jyat182'>STMIK DP</a> </h5>";
    break;
  ...
  // Form Edit YM  
  case "editym":
    $edit=mysqli_query($con,"SELECT * FROM mod_ym WHERE id='$_GET[id]'");
