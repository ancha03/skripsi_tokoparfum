...
switch($_GET[act]){
  ...
  default:
    ...
    $tampil = mysqli_query($con,"SELECT * FROM orders,kustomer WHERE orders.id_kustomer=kustomer.id_kustomer ORDER BY id_orders DESC LIMIT $posisi,$batas");
    ...
    $jmldata = mysqli_num_rows(mysqli_query($con,"SELECT * FROM orders"));
  ...
  $ongkos=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM kota,kustomer,orders 
