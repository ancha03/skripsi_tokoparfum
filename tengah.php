...
if ($_GET[module]=='home'){
  ...
  $sql=mysqli_query($con,"SELECT * FROM produk ORDER BY id_produk DESC LIMIT 6");
...
// Produk Lainnya (random)          
  $sql=mysqli_query($con,"SELECT * FROM produk ORDER BY rand() LIMIT 3");
...
elseif ($_GET[module]=='profilkami'){
  // Data profil mengacu pada id_modul=43
	$profil = mysqli_query($con,"SELECT * FROM modul WHERE id_modul='43'");
  ...
  echo "<div class='center_title_bar'>Profil</div>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Profil Toko Parfum Original</div>
...
elseif ($_GET[module]=='carabeli'){
  ...
  echo "<div class='center_title_bar'>Cara Pembelian</div>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Prosedur Pembelian di Toko Parfum Original</div>
              <div>$r[static_content]</div>
          </div>    
          </div>
            <div class='bottom_prod_box_big'></div>
...
$nama   = antiinjection($con,$_POST['nama']);
$alamat = antiinjection($con,$_POST['alamat']);
$telpon = antiinjection($con,$_POST['telpon']);
$email = antiinjection($con,$_POST['email']);
...
$sql2 = mysqli_query($con,"select email_pengelola,nomor_rekening,nomor_hp from modul where id_modul='43'");
$j2   = mysqli_fetch_array($sql2);
